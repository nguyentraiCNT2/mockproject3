...
const OrderCanCelUser = () => {
  ...
  const fetchOrders = async () => {
    try {
      ...
      const response = await axios.get(`/order/api/oder/userid/list/cancel/${userId}?page=${page}&limit=${limit}`);
          ...
          <div className="container d-flex flex-column">
            <div className="card shadow mb-4">
              ...
              <div className="row ">
                ...
                <h6 className="m-0 font-weight-bold text-primary">Đã hủy </h6>
              </div>
                  <br/>
                {!selectedOrder && (
...
export default OrderCanCelUser;
