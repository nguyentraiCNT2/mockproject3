...
const OrderStatus2 = () => {
    ...
    const fetchOrders = async () => {
        try {
            ...
            const response = await axios.get(`/order/api/oder/userid/list/-status2/${userId}?page=${page}&limit=${limit}`);
                                    ...
                                    <div className="card shadow mb-4">
                                        <div className="card-body">
                                            ...
                                            <div className="card-header py-3">
                                                <h6 className="m-0 font-weight-bold text-primary">Đang giao </h6>
                                            </div>
                                            <br />
                                            {!selectedOrder && (
